...
class Viessmann(SmartPlugin):
    ...
    def create_read_command(self, commandname):
        ...
        packet.extend(self.int2bytes(self._commandbytesread))
    ...
    def create_write_command(self, commandname, value=None):          
        ...
        if set_allowed == True:
            ...
            if value is not None and value != '':
                ...
                if (min_allowed_value == None or min_allowed_value <= value) and (max_allowed_value == None or max_allowed_value >= value):
                    # Create valuebytes
